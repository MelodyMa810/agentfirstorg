...
class DataBaseWorker(BaseWorker):
    ...
    def __init__(self):
        ...
        self.actions = {
            ...
            "CheckBooking": "Check details of booked restaurant(s)",
    ...
    def search_res(self, state: MessageState):
        return self.DBActions.search_res(state)
    
    def book_res(self, state: MessageState):
        return self.DBActions.book_res(state)
    ...
    def _create_action_graph(self):
        ...
        workflow.add_node("SearchRestaurant", self.search_res)
        workflow.add_node("BookRestaurant", self.book_res)
        ...
        workflow.add_edge("SearchRestaurant", "tool_generator")
        workflow.add_edge("BookSRestaurant", "tool_generator")
